  ...
  _('#modal-body').innerHTML = `
    <div id="tabs-settings" class="tabs">
      ...
      <div class="tabs-content">
        <form class="container"><div id="tab-my" class="row"><div class="col-12">
          <button class="is-hidden" type="submit" disabled aria-hidden="true"></button>
          <p>This tab only affects what you can see, not the other players.</p>

          <h2 class="h3">Visible table</h2>
          <p>Switch to a different table:</p>
        ...
        <form class="container"><div id="tab-server" class="row"><div class="col-12">
          <button class="is-hidden" type="submit" disabled aria-hidden="true"></button>
