...
function testApiCrudRoom (api, version, room) {
  ...
  testJsonPost(api, () => '/rooms/', () => {
    ...
    expect(body).to.be.an('object')
    expect(body).to.have.all.keys(['id', 'name', 'engine', 'backgrounds', 'width', 'height', 'library', 'template', 'credits'])
    ...
    expect(Object.keys(body.library)).to.have.members(['tile', 'token', 'overlay', 'tag', 'other'])
