...
describe('Frontend - state.mjs', function () {
  it('getTable() getTemplate() getLibrary()', function () {
    _setTable(undefined)
    expect(getTable()).to.be.eq(undefined)
    expect(getTemplate()).to.be.eq(undefined)

    _setTable(JSON.parse(tableJSON))
    expect(getTable()).to.be.an('object')
    expect(getTable().id).to.be.eq('f9d05a1ecec3ecb8')
