...
import {
  ...
  _setTable,
  setStateNo
} from '../src/js/screens/table/state.mjs'
import {
  findPiece,
  findAsset,
  findPiecesWithin,
...
} from '../src/js/screens/table/tabledata.mjs'

const TEST_STATE = 5

function setupTestData () {
  _setTable(JSON.parse(tableJSON))
  for (let i = 1; i <= 9; i++) {
    if (i === TEST_STATE) {
...
describe('Frontend - tabledata.mjs', function () {
  ...
  it('assetToPiece()', function () {
    ...
    expect(a0.color).to.be.eq('40bfbf')
    expect(a0.side).to.be.eq(0)
    expect(a0.border).to.be.eq(0)
    ...
    expect(a1.color).to.be.eq('40bfbf')
    expect(a1.side).to.be.eq(0)
    expect(a1.border).to.be.eq(0)
    ...
    expect(a2.color).to.be.eq('transparent')
    expect(a2.side).to.be.eq(0)
    expect(a2.border).to.be.eq(0)
  ...
  it('createPieceFromAsset()', function () {
    ...
    expect(piece.border).to.be.eq(0)
...
const tableJSON = '{"id":"f9d05a1ecec3ecb8","name":"selfishExaminingBaboon","engine":"0.3.0","background":{"color":"#423e3d","scroller":"#2b2929","image":"img/desktop-wood.jpg"},"library":{"overlay":[{"assets":["area.1x1.1x1x1.svg","##BACK##"],"w":1,"h":1,"color":"#808080","alias":"area.1x1","type":"overlay","id":"7261fff0158e27bc"}],"tile":[{"assets":["altar.3x2x1.transparent.png","##BACK##"],"w":3,"h":2,"color":"transparent","alias":"altar","type":"tile","id":"5b150d84cee577dc"}],"token":[{"assets":["aasimar.1x1x1.border.svg","##BACK##"],"w":1,"h":1,"color":"border","alias":"aasimar","type":"token","id":"484d7d45fdc27afa"}],"other":[{"assets":["classic.a.1x1x1.svg","classic.a.1x1x2.svg","classic.a.1x1x3.svg"],"w":1,"h":1,"color":"#808080","alias":"classic.a","type":"other","id":"f45f27b57498c3be","base":"classic.a.1x1x0.png"},{"assets":["dicemat.4x4x1.jpg","##BACK##"],"w":4,"h":4,"color":"#808080","alias":"dicemat","type":"other","id":"bb07ac49818bc000"},{"assets":["discard.4x4x1.jpg"],"w":4,"h":4,"color":"#808080","alias":"discard","type":"other","id":"dd07ac49818bc000"}],"note":[]},"template":{"type":"grid-square","version":"0.9.0-dev","engine":"^0.3.0","gridSize":64,"gridWidth":48,"gridHeight":32,"snapSize":32,"colors":[{"name":"black","value":"#0d0d0d"},{"name":"blue","value":"#061862"},{"name":"white","value":"#ffffff"}]},"credits":"test template","width":3072,"height":2048}'
